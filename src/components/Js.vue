...
document.addEventListener("DOMContentLoaded", function () {
  new Swiper(".hero__slider", {
    ...
    scrollbar: { el: ".hero__scrollbar" },
  }),
    new Swiper(".cards__slider", {
      slidesPerView: 1,
      spaceBetween: 15,
      pagination: { el: ".cards__nav_pagination", type: "fraction" },
      navigation: { nextEl: ".cards__nav_next", prevEl: ".cards__nav_prev" },
      breakpoints: {
        400: { slidesPerView: 2 },
        767: { slidesPerView: 3 },
    ...
    new Swiper(".cards__slider--three-block", {
      slidesPerView: 1,
      spaceBetween: 15,
      pagination: { el: ".cards__nav_pagination", type: "fraction" },
      navigation: { nextEl: ".cards__nav_next", prevEl: ".cards__nav_prev" },
  ...
  new Swiper(".reviews__slider", {
    ...
    new Swiper(".developments__slider", {
      slidesPerView: 1,
      spaceBetween: 15,
      pagination: { el: ".developments__nav_pagination", clickable: !0 },
      breakpoints: {
        480: { slidesPerView: 2 },
        992: { slidesPerView: 3, spaceBetween: 30 },
      },
    }),
    new Swiper(".certified__slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      navigation: {
    ...
    new Swiper(".video__slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      pagination: { el: ".video__pagination", clickable: !0 },
      navigation: {
